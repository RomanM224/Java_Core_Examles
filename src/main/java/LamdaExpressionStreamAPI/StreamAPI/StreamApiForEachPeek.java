...
public class StreamApiForEachPeek {

    public static void main(String[] args) {
        testForEach();
    }

    // Метод ForEach применяет указанный метод к каждому элементу стрима и
    // заканчивает работу со стримом
    ...
    // Метод Peek возвращает тот же стрим, но при этом применяет указанный метод к
